...
part 'information_content_view_mixin.dart';

@RoutePage()
class InformationContentView extends BaseView
    with _InformationContentViewMixin {
  const InformationContentView({super.key});
